  ...
  return (
    <>
      <motion.section
        ...
        className="relative flex flex-col-reverse md:flex-row items-center justify-center min-h-screen px-6 sm:px-10 md:px-20 bg-linear-to-br from-[#F7EDE2] via-[#FAF6F0] to-[#F0E1CF]  dark:from-[#1A1410] dark:via-[#2C221C] dark:to-[#3B2E26] text-neutral-900 dark:text-[#FDF8F3] transition-colors duration-700 overflow-hidden pb-5"
      >
              ...
              >
                ...
                >
                  <p className="text-sm sm:text-base md:text-[1.05rem] font-medium leading-snug text-transparent bg-clip-text bg-linear-to-r from-yellow-700 via-yellow-800 to-amber-700 drop-shadow-[0_1px_2px_rgba(0,0,0,0.25)]">
                    🚀 Mission: Designing elegant, AI-powered web experiences
                    that combine innovation and usability.
                  </p>
                </motion.div>

                {/* Card Footer */}
                <div className="mt-3 flex items-center justify-between p-2 text-sm font-mono text-neutral-700 dark:text-neutral-300 hover:text-amber-600 dark:hover:text-amber-400 transition-colors duration-300">
                  <span>Syed</span>
        ...
        leading-tight sm:leading-snug md:leading-relaxed"
            ...
            >
              👋 Hi, I’m <br />
              <Cover className="inline-block bg-transparent dark:bg-transparent">
                Syed Husamuddin
              </Cover>
            </motion.h1>
